...
<section style={{ minHeight: "100vh", position: "relative", display: "flex", alignItems: "center", overflow: "hidden" }}>
  ...
  <div className="container" style={{ position: "relative", zIndex: 3, paddingTop: "8rem" }}>
    ...
    <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.25 }}
      ...
      Shape Your<br /><em style={{ color: "#e84e0f" }}>Future</em> at a<br />World-Class<br />Institution
    </motion.h1>
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }}
      ...
      <section className="section" style={{ background: "#f8f4ef" }}>
        <div className="container" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          <FadeUp>
            <p style={{ fontSize: "0.72rem", letterSpacing: "0.25em", textTransform: "uppercase", color: "#e84e0f", marginBottom: "1rem" }}>About Us</p>
            <h2 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(2.2rem, 4vw, 3.5rem)", fontWeight: 300, color: "#1a1a2e", marginBottom: "1.2rem" }}>
              A Legacy of Academic <em style={{ color: "#e84e0f" }}>Excellence</em>
            </h2>
            ...
            <Link href="/about" className="btn btn-orange">Learn More</Link>
          </FadeUp>
          <FadeUp delay={0.15}>
      ...
      <section className="section" style={{ background: "#ffffff" }}>
        <div className="container">
          <FadeUp style={{ textAlign: "center", marginBottom: "4rem" }}>
            <p style={{ fontSize: "0.72rem", letterSpacing: "0.25em", textTransform: "uppercase", color: "#e84e0f", marginBottom: "1rem" }}>Academic Programs</p>
          ...
          <FadeUp style={{ textAlign: "center", marginTop: "3rem" }}>
            <Link href="/programs" className="btn btn-orange">View All Programs</Link>
          </FadeUp>
        </div>
      </section>
      ...
      <section style={{ background: "#003366", padding: "6rem 0" }}>
        <div className="container" style={{ textAlign: "center" }}>
          <FadeUp>
            <p style={{ fontSize: "0.72rem", letterSpacing: "0.25em", textTransform: "uppercase", color: "#e84e0f", marginBottom: "1rem" }}>Begin Your Journey</p>
            ...
            <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <Link href="/contact" className="btn btn-outline-orange" style={{ color: "#f8f4ef" }}>Contact Admissions</Link>
            </div>
          </FadeUp>
        </div>
      </section>
