...
const programs: Record<string, {
  ...
  "international-business-retail-management": {
    ...
    fees: "Contact admissions for current tuition", certification: " Level 6 Title (confirm registration number with NSBI)",
    ...
    whatsappMsg: "Hello, I am interested in the International Business & Retail Management Bachelor at NSBI. Could you please provide more information?",
  },
  "sales-project-management": {
    ...
    whatsappMsg: "Hello, I am interested in the Sales & Project Management Bachelor at NSBI. Could you please provide more information?",
  },
  "hospitality-tourism-management": {
    ...
    whatsappMsg: "Hello, I am interested in the Hospitality & Tourism Management Bachelor at NSBI. Could you please provide more information?",
  },
  "entrepreneurship-startup-strategies": {
    ...
    whatsappMsg: "Hello, I am interested in the Entrepreneurship & Startup Strategies Bachelor at NSBI. Could you please provide more information?",
  },
  "master-international-business-management": {
    ...
    intake: "September / October or January / February",
    fees: "Contact admissions for current tuition", certification: " Level 7 Title (confirm registration number with NSBI)",
    ...
    whatsappMsg: "Hello, I am interested in the International Business Management Mastère at NSBI. Could you please provide more information?",
  },
  "master-hotel-tourism-management": {
    ...
    whatsappMsg: "Hello, I am interested in the Hotel & Tourism Management Mastère at NSBI. Could you please provide more information?",
  },
  "master-entrepreneurship-startup-strategies": {
    ...
    whatsappMsg: "Hello, I am interested in the Entrepreneurship & Startup Strategies Mastère at NSBI. Could you please provide more information?",
  },
  "master-international-marketing": {
    ...
    whatsappMsg: "Hello, I am interested in the International Marketing Mastère at NSBI. Could you please provide more information?",
  },
  "master-human-resource-management": {
    ...
    whatsappMsg: "Hello, I am interested in the Human Resources Management Mastère at NSBI. Could you please provide more information?",
  },
  "master-luxury-brand-management": {
    ...
    whatsappMsg: "Hello, I am interested in the Luxury Brand Management Mastère at NSBI. Could you please provide more information?",
  },
    ...
    whatsappMsg: "Hello, I am interested in the BBS International Business Management program at NSBI. Could you please provide more information?",
  },
  "bbs-hotel-and-tourismmanagement": {
    ...
    whatsappMsg: "Hello, I am interested in the BBS Hotel and Tourism Management program at NSBI. Could you please provide more information?",
  },
    "dba": {
    code: "DBA", title: "Doctorate in Business Administration",
    level: "Doctorate", duration: "3 Years",
    intake: "September / October or January / February",
    fees: "From €3,200 (1st year, non-European) / €1,600/year thereafter — tiered by residency, confirm with NSBI",
    ...
    whatsappMsg: "Hello, I am interested in the DBA program at NSBI. Could you please provide more information?",
  },
  "fle": {
    ...
    intake: "September / October or January / February",
    fees: "Contact admissions for current tuition",
    certification: "NSBI French Language Certificate of Completion",
    objective: "NSBI's French as a Foreign Language programme supports international students in building the language skills needed to thrive academically, professionally, and socially in France — taught alongside your main degree programme.",
    semesters: [
    ...
    whatsappMsg: "Hello, I am interested in the FLE (French as a Foreign Language) program at NSBI. Could you please provide more information?",
  },
};
const WAIcon = () => (
    ...
    <>
      ...
      <section className="prog-hero" style={{ minHeight: "60vh", position: "relative", display: "flex", alignItems: "center", overflow: "hidden", padding: "8rem 0 5rem" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          ...
          <h1 className="prog-h1" style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(2.2rem, 6vw, 5rem)", fontWeight: 300, lineHeight: 1.1, color: "#0d1b2e", marginBottom: "2rem", maxWidth: "800px" }}>
            {p.title}
          </h1>
          ...
          <div className="prog-hero-btns" style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
      ...
      <section style={{ background: "#e84e0f" }}>
        <div className="container prog-info-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)" }}>
          {[
            ...
            <div key={item.label} className="prog-info-item" data-idx={i} style={{ padding: "1.5rem 1rem", borderRight: i < 3 ? "1px solid rgba(255,255,255,0.2)" : "none", textAlign: "center" }}>
      ...
      <section className="section" style={{ background: "#fff" }}>
        <div className="container prog-objective-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "start" }}>
          <FadeUp>
            ...
            <h2 className="prog-h2" style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(1.9rem, 3.5vw, 3rem)", fontWeight: 300, color: "#0d1b2e", marginBottom: "1.5rem" }}>{td("aboutProgram")}</h2>
            ...
            <a href={waUrl} target="_blank" rel="noopener noreferrer" className="prog-wa-btn"
              style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: "10px", padding: "1rem 2rem", background: "#25D366", color: "#fff", fontFamily: "Montserrat, sans-serif", fontSize: "0.82rem", fontWeight: 700, letterSpacing: "0.04em", textTransform: "uppercase", textDecoration: "none", transition: "background 0.2s" }}
          ...
          <FadeUp delay={0.15}>
            <div style={{ background: "#003366", padding: "2rem", color: "#fff" }}>
      ...
      <section className="section" style={{ background: "#f4f4f4" }}>
        <div className="container">
          <FadeUp style={{ marginBottom: "3rem" }}>
            ...
            <h2 className="prog-h2" style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(1.9rem, 3.5vw, 3rem)", fontWeight: 300, color: "#0d1b2e" }}>{td("programStructure")}</h2>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            {p.semesters.map((sem, i) => (
              <FadeUp key={sem.label} delay={i * 0.08}>
                <div className="prog-sem-card" style={{ background: "#fff", border: "1px solid #e0e0e0", borderLeft: "4px solid #e84e0f", padding: "2rem" }}>
      ...
      {/* ── BOTTOM CTA ── */}
      <section className="prog-cta" style={{ background: "#0d1b2e", padding: "5rem 0" }}>
        <div className="container" style={{ textAlign: "center" }}>
          <FadeUp>
            ...
            <h2 className="prog-h2" style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(1.9rem, 4vw, 3.5rem)", fontWeight: 300, color: "#fff", marginBottom: "1rem" }}>{td("ctaH2")}</h2>
            <p style={{ fontFamily: "Open Sans, sans-serif", fontSize: "0.95rem", color: "rgba(255,255,255,0.55)", marginBottom: "2.5rem" }}>{td("ctaP")}</p>
            <div className="prog-cta-btns" style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
              <a href={waUrl} target="_blank" rel="noopener noreferrer"
                style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: "8px", padding: "0.85rem 2rem", background: "#25D366", color: "#fff", fontFamily: "Montserrat, sans-serif", fontSize: "0.82rem", fontWeight: 700, letterSpacing: "0.05em", textTransform: "uppercase", textDecoration: "none", border: "2px solid #25D366", transition: "all 0.2s" }}
      ...
      <style jsx global>{`
        @media (max-width: 768px) {
          ...
          .prog-info-item[data-idx="0"],
          .prog-info-item[data-idx="1"] {
            border-bottom: 1px solid rgba(255,255,255,0.2) !important;
          }
          .prog-info-item[data-idx="1"] {
            border-right: none !important;
          }
          .prog-info-item[data-idx="2"] {
            border-right: 1px solid rgba(255,255,255,0.2) !important;
          }
          .prog-info-item[data-idx="3"] {
            border-right: none !important;
          }
